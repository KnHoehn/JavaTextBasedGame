...
To run the game you will need to download and install Java JDK version 11 or higher and install Apache Maven. At this time, there is not a hosted database so a database needs to be created locally on your machine.
